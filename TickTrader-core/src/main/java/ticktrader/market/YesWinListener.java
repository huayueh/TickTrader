 ...
 * Date: 2015/4/16
 */
public class YesWinListener {
    private static final String SERVICE = "YES";
    private static final String TOPIC = "DQ";
    private static final String ITEM = "TX409700P5.Price";
    ...
    public static void main(String[] args) {
        try {
            ...
            //PUT
            conversation.startAdvice("TX409650P5.Price");
            conversation.startAdvice("TX409600P5.Price");
            conversation.startAdvice("TX409550P5.Price");
            conversation.startAdvice("TX409500P5.Price");
            //CALL
            conversation.startAdvice("TX409650D5.Price");
            conversation.startAdvice("TX409600D5.Price");
            conversation.startAdvice("TX409550D5.Price");
            conversation.startAdvice("TX409500D5.Price");
